...
class DriverReviewDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ->editColumn('updated_at', function ($columns) {
                return getDateColumn($columns, 'updated_at');
            })
            ->addColumn('action', 'driver_reviews.datatables_actions')
    ...
    {
        return $model->newQuery()->with('user', 'driver');
    }
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'driver.name',
                'title' => trans('lang.driver_review_driver_id'),
        ...
        if ($hasCustomField) {
            ...
            foreach ($customFieldsCollection as $key => $field) {
                array_splice($columns, $field->order - 1, 0, [[
                    ...
                    'title' => trans('lang.driver_review_' . $field->name),
                    'orderable' => false,
                    'searchable' => false,
                ]]);
            }
